...
print('Load data...')
path = 'F:\\alhealthy\\alhealthy\\data_app/'
...
# ----------------------------------- lgb
    ...
    data_train = np.column_stack((data_train, label_train[:, 0]))
    data_train = np.column_stack((data_train, label_train[:, 3]))
    data_test = np.column_stack((data_test, prediction0, prediction3))
    print(data_train.shape)
    print("ok")
    ...
    # -----------------------0,3,1 for 4
    data_train = np.column_stack((data_train, label_train[:, 1]))
    data_test = np.column_stack((data_test, prediction1))
    ...
    # -----------------------0,3,1, 4 for 2
    data_train = np.column_stack((data_train, label_train[:, 4]))
    data_test = np.column_stack((data_test, prediction4))
