...
df_test = pd.read_csv(path + 'test_use_nan_change3.csv', delimiter=',', encoding='gbk', index_col=0)
...
df_test.to_csv(train_save + 'x_test_label_nan_change4.csv', sep=',')
x_test = df_test.loc[:, :].values
np.savetxt(save_path + 'x_test_nan_change4.txt', x_test, delimiter=',')
